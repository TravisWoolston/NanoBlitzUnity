...
public class InteractDemoManager : MonoBehaviour 
{
	...
	void Start()
	{
		...
		InvokeRepeating("DisplayLogs", 0f, 2f);
	}
	void DisplayLogs() {
		Debug.Log("m_ExplosiveForce " + m_ExplosiveForce);
		Debug.Log("m_ImplosiveForce " + m_ImplosiveForce);
		Debug.Log("m_ForceRadius " + m_ForceRadius);
